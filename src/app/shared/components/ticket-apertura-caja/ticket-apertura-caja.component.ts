...
@Component({
  selector: 'app-ticket-apertura-caja',
  templateUrl: './ticket-apertura-caja.component.html',
})
export class TicketAperturaCajaComponent implements OnInit {
  ...
  printTicket() {
    ...
    if (windowPrint && printContent) {
      windowPrint.document.body.innerHTML = '';
